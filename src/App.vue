<template>
  ...
  <div id="app">
    ...
    <div v-if="!showLogos" class="side">
      <a href="https://twitter.com/Loadens"> <img src="./assets/twitter.svg" alt=""></a>
